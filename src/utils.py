...
# from torch._six import string_classes  # handan: the package was no longer available in my pytorch, so I modified it
...
def trim_collate(batch):
    ...
    if torch.is_tensor(batch[0]):
        ...
        return batch
    # change the collections.Mapping to abc.Mapping, raised due to different python version
